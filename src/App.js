...
class App extends Component {
        ...
        <form className="csvForm" action="" id="basic-form">
          ...
          <div className="browse1" >
            ...
            <div className="companyDetail" id="cName-div">
              <input type="text" id="cname_input" required/>
              <label>Company Name</label><br/>
                <span className="csv_img_msg"></span>
            </div>          
            
            <div className="companyDetail" id="ctc-div">
              <input type="text" id="ctc_input" required/>
          ...
          <a href="#dvCSV" ><button type="button" id="upload" className="submit" onClick={this.submitHandler}>Submit</button></a>
      </form>
  ...
  <button type="button" id="mailbut1"><b>Send mail?</b></button>
  </div>
  </form>
